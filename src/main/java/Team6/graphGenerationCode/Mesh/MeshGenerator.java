package Team6.graphGenerationCode.Mesh;
...
public class MeshGenerator {
	 ...
	 * 
	 * @param i1  - first node row #
	 * @param j1- first node column #
	 * @param i2- second node row #
	 * @param j2- second node column #
	 * @param cap - the capacity entry
	 */
	...
	/**
	 * Constructor for mesh generator parses the command line arguments and sets the
	 * defaults. See the class comment for arguments/defaults.
	 * 
	 * @param args - the command line arguments. See class comment.
	 */
